...
- (void)viewDidLoad
{
	...
	CGRect frame1 = CGRectMake(originX, originY, moduleWidth, moduleWidth);
	...
	originX+= moduleWidth+margin;
	CGRect frame3 = CGRectMake(originX, originY, moduleWidth, moduleWidth);
	iconView3 = [[UIImageView alloc]initWithFrame:frame3];
	
	originY+= moduleWidth+margin;
	originX=margin;
	CGRect frame4 = CGRectMake(originX, originY, moduleWidth, moduleWidth);
	iconView4 = [[UIImageView alloc]initWithFrame:frame4];
	
	originX+= moduleWidth+margin;
	CGRect frame5 = CGRectMake(originX, originY, moduleWidth, moduleWidth);
	iconView5 = [[UIImageView alloc]initWithFrame:frame5];
	
	originX+= moduleWidth+margin;
	CGRect frame6 = CGRectMake(originX, originY, moduleWidth, moduleWidth);
	iconView6 = [[UIImageView alloc]initWithFrame:frame6];
	
	originY+= moduleWidth+margin;
	originX=margin;
	
	CGRect frame7 = CGRectMake(originX, originY, moduleWidth, moduleWidth);
	iconView7 = [[UIImageView alloc]initWithFrame:frame7];
	
	originX+= moduleWidth+margin;
	CGRect frame8 = CGRectMake(originX, originY, moduleWidth, moduleWidth);
	iconView8 = [[UIImageView alloc]initWithFrame:frame8];
	
	originX+= moduleWidth+margin;
	CGRect frame9 = CGRectMake(originX, originY, moduleWidth, moduleWidth);
	iconView9 = [[UIImageView alloc]initWithFrame:frame9];
